        ...
        <div className="container mx-auto px-3 md:px-10">
            ...
            <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
                ...
                <div className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
                    ...
                    title={<>n<b>e</b>xus</>}
                    description="A gamified social hub, adding a new dimenstion of play to your identiy, Web3 engagement and social interaction"
                    />
                </div>
                ...
                <div className="bento-tilt_1 row-span-1 md:col-span-1 me-14 md:me-0">
                    ...
                    title={<>n<b>e</b>xus</>}
                    description="A crossworld AI Agent-elevating your gameply to be more fun and productive."
                    />
                </div>
